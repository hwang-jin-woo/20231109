                  ...
                  <div className="login-wrap">
                    ...
                    <div>
                      <ul className="buttons">        
                          <li><Link to={"/reservation"}><button className="button"><h2>예약 하기</h2></button></Link></li>
                          <li><Link to={"/ReservationConfirm"}><button className="button"><h2>예약 확인</h2></button></Link></li>
                          <li><Link to={"/ReservationStatus"}><button className="button"><h2>예약자 현황</h2></button></Link></li>
                          <li><Link to={"/HospitalInformation"}><button className="button"><h2>병원 정보</h2></button></Link></li>        
                        </ul>
                    </div>
              </section>
          </main>
